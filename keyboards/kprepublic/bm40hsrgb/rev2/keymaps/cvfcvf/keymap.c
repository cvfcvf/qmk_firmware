...
[_BASE] = LAYOUT_ortho_4x12_1x2uC(
    ...
    KC_LCTL, RGB_TOG, KC_LGUI, KC_LALT, TL_LOWR,      SPC_NAV,     TL_UPPR, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_NAV] = LAYOUT_ortho_4x12_1x2uC(
    ...
    KC_LCTL, RGB_TOG, KC_LGUI, KC_LALT, TL_LOWR,      SPC_NAV,     KC_RALT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
