...
[_BASE] = LAYOUT_ortho_4x12_1x2uC(
    ...
    LS_CAP , em_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  MINSemacs, KC_ENT ,
...
[_SYM] = LAYOUT_ortho_4x12_1x2uC(
    ...
    _______,      miEURO , ES_LABK, ES_RABK, ES_PIPE, ES_QUOT, esBQUOT, ES_HASH,    ES_LCBR,    ES_RCBR, ES_AT  , _______,
...
/*    ESC  ,    Q   ,    W   ,    E   ,    R   ,    T   ,    Y   ,    U   ,    I   ,    O   ,    P   ,    BS    */
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, BUFFER , TeXnERR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, 
