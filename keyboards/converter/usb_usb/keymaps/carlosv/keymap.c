...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ______,  ______,  ______,  ______,  ______, ______, ______, KC_HOME, KC_PGUP,KC_PGDN,  KC_END, ______, ______,         ______,     ______,______,______,    ______,______,______,______,    ______,______,
    KC_LGUI, ______,  ______,  ______,  ______, ______, KC_INS, KC_LEFT, KC_DOWN,  KC_UP, KC_RGHT, ______,         ______, ______,                              ______,______,______,______,    ______,______,
