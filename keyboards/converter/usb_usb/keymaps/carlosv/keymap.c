...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_MHEN, KC_HANJ,         SPC_NAV,        KC_HAEN, KC_HENK, KC_KANA, KC_RALT, KC_RGUI, MNUmed,  KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT, KC_PENT,    KC_FIND, KC_CUT
    ),
    [_NAV] = LAYOUT_all(
    ...
    ______,  ______,  ______,  ______,  ______, ______, KC_PGUP, KC_HOME,KC_UP  , KC_END,  ______, ______, ______,         ______,     ______,______,______,    ______,______,______,______,    ______,______,
    KC_LGUI, ______,  ______,  ______,  ______, ______, KC_PGDN, KC_LEFT,KC_DOWN,KC_RGHT,  ______, ______,         ______, ______,                              ______,______,______,______,    ______,______,
