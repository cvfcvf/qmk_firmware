...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ______,  ______,  ______,  ______,  ______, ______, KC_PGUP, CTLEFT , KC_UP , CTRGHT,  ______, ______, ______,         ______,     ______,______,______,    ______,______,______,______,    ______,______,
