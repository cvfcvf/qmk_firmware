...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    ______,  ______,  ______,  ______,  ______, KC_INS, KC_PGUP, CTLEFT , KC_UP , CTRGHT,  KC_BSPC,______, ______,         ______,     ______,______,______,    ______,______,______,______,    ______,______,
    KC_LGUI, ______,  ______,  ______,  ______,KC_CAPS, KC_PGDN, KC_LEFT,KC_DOWN,KC_RGHT,  KC_DEL, ______,         ______, ______,                              ______,______,______,______,    ______,______,
