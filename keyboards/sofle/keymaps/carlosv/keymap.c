...
#define TABmed LT(_ADJUST,KC_TAB)
#define TABsym LT(SYM1,KC_TAB)
#define ESCmed LT(_ADJUST,KC_ESC)
#define MNUmed LT(_ADJUST,KC_APP)
...
[_QWERTY] = LAYOUT(
  ...
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_MUTE,     XXXXXXX,KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_RSFT,
                 KC_LGUI,KC_LALT,KC_LCTL, KC_LOWER, KC_ENT,      KC_SPC,  SPC_NAV , KC_RCTL, KC_RALT, KC_RGUI
),
/*
 * COLEMAK
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_RAISE] = LAYOUT(
  ...
  _______, _______,  _______,  _______,  _______, KC_CAPS,                       KC_PGDN,  KC_LEFT, KC_DOWN, KC_RGHT,  KC_DEL, KC_BSPC,
