 ...
 */
  ...
  LS_CAP ,  em_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_MUTE,  KC_D_MUTE,KC_N,    KC_M,   KC_COMM, KC_DOT,  MINSemacs,KC_ENT ,
                 KC_LCTL, KC_LGUI, KC_LALT, TL_LOWR,  TL_UPPR,  KC_BSPC,SPC_NAV ,  KC_RAISE, KC_RCTL, KC_RALT
),
 ...
 */
  ...
  //  RGB_TOG, RGB_HUI,RGB_SAI, RGB_VAI, TG(_COLEMAKDH),TG(_COLEMAK),             C(G(KC_LEFT)),KC_NO,KC_NO,C(G(KC_RGHT)),XXXXXXX, XXXXXXX,
...
[_NUMPAD] = LAYOUT(
  ...
  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,_______,   _______,KC_PLUS, KC_P1,  KC_P2,   KC_P3,   KC_SLSH, _______,
              _______, OSM(MOD_MEH), _______, _______, _______,   _______,KC_SPC ,  KC_P0,   KC_PDOT, _______
),
...
[_NAV] = LAYOUT(
    ...
    _______, KC_UNDO, XXXXXXX, KC_WBAK, KC_WFWD, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, KC_HOME, XXXXXXX, KC_END , XXXXXXX, KC_ENT ,
