 ...
 */
  ...
  TABGUI ,  KC_A,   HR_S,    HR_D,    HR_F,    KC_G,                      KC_H,    HR_J,   HR_K,    HR_L,    KC_SCLN, KC_QUOT,
  LS_CAP ,  em_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_MUTE,  KC_MUTE,  KC_N,    KC_M,   KC_COMM, KC_DOT,  MINSemacs,KC_ENT ,
                 KC_LCTL, KC_LGUI, KC_LALT, TL_LOWR,  TL_UPPR,  KC_BSPC,SPC_NAV ,  KC_RALT, KC_APP, KC_RCTL
),
...
[_SYM] = LAYOUT(// _LOWER
    ...
    ES_TILD    ,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,
    ALGR(KC_GRV), ES_EXLM, ES_DQUO, ES_BULT, ES_DLR,  ES_PERC,                   ES_AMPR, ES_IEXL, ES_LBRC, ES_RBRC, ES_EXLM, ES_CCED,
    KC_DEL,       ES_EQL,  ES_PLUS, ES_ASTR, ES_SLSH, ES_CIRC,                   ES_BSLS, ES_IQUE, ES_LPRN, ES_RPRN, ES_QUES, ES_GRV ,
    _______,      miEURO , ES_LABK, ES_RABK, ES_PIPE, ES_QUOT, _______, _______, esBQUOT, ES_HASH, ES_LCBR, ES_RCBR, ES_AT  , _______,
 ...
 */
  ...
  RGB_TOG, RGB_HUI,RGB_SAI, RGB_VAI, KC_COLEMAKDH,KC_COLEMAK ,            XXXXXXX, KC_VOLD, KC_MUTE, KC_VOLU, XXXXXXX, XXXXXXX,
  RGB_MOD, RGB_HUD,RGB_SAD, RGB_VAD, DF(_NUM),KC_QWERTY,XXXXXXX, XXXXXXX, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX,
                   _______, _______, _______, _______, _______,  _______, _______, _______, _______, _______
),
/* NUMPAD
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_NAV] = LAYOUT(
    ...
    KC_GRV , XXXXXXX, XXXXXXX, KC_APP , XXXXXXX, KC_INS ,                      KC_PGUP, CTLEFT,  KC_UP,   CTRGHT,  XXXXXXX, KC_F12 ,
    _______, _______, _______, _______, _______, CW_TOGG,                      KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL , XXXXXXX,
    _______, KC_UNDO, XXXXXXX, KC_WBAK, KC_WFWD, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, KC_HOME, KC_DEL , KC_END , XXXXXXX, KC_ENT ,
                      KC_LCTL, KC_LGUI, KC_LALT, TL_LOWR, TL_UPPR,    XXXXXXX, SPC_NAV, KC_RALT, KC_VOLD, KC_VOLU

	),

[_EMACS] = LAYOUT(
    _______, NODIV  , DIVH   , DIVV   , XXXXXXX, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
    XXXXXXX, XXXXXXX, SAVE_AS, XXXXXXX, RECENT , XXXXXXX,                      XXXXXXX, XXXXXXX, IBUFFER, XXXXXXX, ORGPDF , XXXXXXX,
    XXXXXXX, XXXXXXX, SAVE   , DIRED  , OPEN   , MAGIT  ,                      XXXXXXX, XXXXXXX, KILL   , XXXXXXX, XXXXXXX, XXXXXXX,
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, BUFFER , XXXXXXX,    XXXXXXX, TeXnERR, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                      KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, XXXXXXX,    XXXXXXX, SPC_NAV, KC_RALT, KC_VOLD, KC_VOLU
  ),
};

// esto es necesario porque el triestado en process_record_user solo
// funciona con keycodes especiales para cambio de capa, y estoy
// usando los keycodes normales. En este caso, además, no es la misma
...
static void print_status_narrow(void) {
    ...
    oled_write_P(PSTR("CL"), led_state.caps_lock);
    oled_write_P(PSTR(" "),false);
    oled_write_P(PSTR("NL\n"), led_state.num_lock);
    ...
    oled_write_P(PSTR("\n\n"), false);
    // Print current layer
    //    oled_write_ln_P(PSTR("LAYER"), led_state.caps_lock);
    oled_write_ln_P(PSTR("LAYER"), is_caps_word_on());
