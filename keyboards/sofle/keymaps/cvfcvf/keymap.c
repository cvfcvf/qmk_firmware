...
[_NAV] = LAYOUT(
    ...
    _______, KC_UNDO, XXXXXXX, KC_WBAK, KC_WFWD, XXXXXXX, XXXXXXX,    XXXXXXX, XXXXXXX, KC_HOME, KC_BSPC, KC_END , XXXXXXX, KC_ENT ,
...
[_EMACS] = LAYOUT(
    ...
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, BUFFER , XXXXXXX,    XXXXXXX, TeXnERR, KC_HOME, XXXXXXX, KC_END , XXXXXXX, XXXXXXX,
