...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_60_iso(
    ...
    KC_LCTL, KC_LGUI, KC_LALT,                            LT(2,KC_SPC),                       KC_RALT, LT(1,KC_APP), MO(2),   KC_RCTL),
  ...
  [3] = LAYOUT_60_iso(
    _______, KC_MPLY, KC_MSTP, KC_MPRV, KC_MNXT, KC_MUTE, KC_VOLD, KC_VOLU, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DEL,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_HOME, KC_PGUP,   KC_END,  XXXXXXX, XXXXXXX, XXXXXXX,
